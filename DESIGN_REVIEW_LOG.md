...
| 2026-09-15 | Location layout strategy | Packed grid vs force-directed vs concentric cluster layout | Clustered force layout inside each country group | Reduce rigid grid appearance while keeping related people visually grouped within fixed country containers | @Lloydshove | Yes (design approved) |
